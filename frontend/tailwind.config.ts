    ...
    extend: {
      colors: {
        ...
        sa: {
          ...
          "off-white":  "rgb(var(--sa-off-white) / <alpha-value>)",
          ...
          navy:         "rgb(var(--sa-navy) / <alpha-value>)",
          "navy-deep":  "rgb(var(--sa-navy-deep) / <alpha-value>)",
          "navy-soft":  "rgb(var(--sa-navy-soft) / <alpha-value>)",
          gold:         "rgb(var(--sa-gold) / <alpha-value>)",
          "gold-light": "rgb(var(--sa-gold-light) / <alpha-value>)",
          "gold-dark":  "rgb(var(--sa-gold-dark) / <alpha-value>)",
          "gold-soft":  "rgb(var(--sa-gold-soft) / <alpha-value>)",
          // Status
      ...
      fontSize: {
        ...
        "display-2xl": ["clamp(3.5rem, 8vw, 7rem)", { lineHeight: "0.94", letterSpacing: "-0.055em" }],
        "display-xl": ["clamp(2.75rem, 6vw, 5rem)", { lineHeight: "1", letterSpacing: "-0.045em" }],
        "display-lg": ["clamp(2.15rem, 4.5vw, 3.75rem)", { lineHeight: "1.05", letterSpacing: "-0.035em" }],
      ...
      boxShadow: {
        ...
        "sa-premium":"0 24px 80px -32px rgb(7 7 17 / 0.42)",
        "sa-glass":"0 24px 80px -32px rgb(0 0 0 / 0.5), inset 0 1px 0 rgb(255 255 255 / 0.12)",
      },
